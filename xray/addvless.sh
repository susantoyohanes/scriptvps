...
xrayvless1="vless://${uuid}@${domain}:$tls?path=/natanssh&security=tls&encryption=none&type=ws#${user}"
xrayvless2="vless://${uuid}@${domain}:$nontls?path=/natanssh&encryption=none&type=ws#${user}"
